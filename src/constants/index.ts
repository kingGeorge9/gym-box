...
export const USER_PROGRAMS = [
  ...
  },
  {
    id: 3,
    first_name: "Kemi",
    profilePic: "./kemi.jpeg",
    fitness_goal: "Wellness Detox Diet",
    height: "5'4\"",
    weight: "130 lbs",
    age: 45,
    workout_days: 3,
    injuries: "Knee pain",
    fitness_level: "Intermediate",
    equipment_access: "Reduce stress and improve mobility",
    ...
    workout_plan: {
      ...
      description:
        "This program gives the gut a break from heavy, processed foods. It supports healthy bowel movements, reduces bloating and restores electrolyte balance.",
    },
    diet_plan: {
      title: "Wellness Detox / Reset Program",
